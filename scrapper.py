...
"""
This is the scrapper for the Finetuned version of the schema for semantic search.
This version has two vectors. (fields to be vectorized: title_type_text_to_embed, title_type_to_embed)
"""
